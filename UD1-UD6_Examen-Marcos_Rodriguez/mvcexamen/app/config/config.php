...
define('API_URL', 'http://localhost/UD1-UD6_Examen-Marcos_Rodriguez/api-server/public');

// Ruta url Ejemplo: http://localhost/ud5/mvc2app
// define ('RUTA_URL', '_URL_');
define('RUTA_URL', 'http://localhost/UD1-UD6_Examen-Marcos_Rodriguez/mvcexamen/');
