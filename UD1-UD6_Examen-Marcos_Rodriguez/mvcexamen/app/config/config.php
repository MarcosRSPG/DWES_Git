...
define('DB_HOST', 'miwww'); // tu servidor de BD.
...
define('API_URL', 'http://miwww/UD1-UD6_Examen-Marcos_Rodriguez/api-server/public');

// Ruta url Ejemplo: http://miwww/ud5/mvc2app
// define ('RUTA_URL', '_URL_');
define('RUTA_URL', 'http://miwww/UD1-UD6_Examen-Marcos_Rodriguez/mvcexamen/');
